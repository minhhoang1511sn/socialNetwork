                ...
                <tr>
                    <td align="center" valign="top" style="padding: 36px 24px;">
                        <a href="https://www.blogdesire.com" target="_blank" style="display: inline-block;">
                            <img src="https://store-images.s-microsoft.com/image/apps.57837.9007199266516256.7561d7b1-4233-418e-be4d-01fb5615c46a.a14d031c-8b43-40f9-8c21-62e87cfbb7fa" alt="Logo"
                                 border="0" width="48"
        ...
        <td align="center" bgcolor="#e9ecef">
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                ...
                <tr>
                    <td align="left" bgcolor="#ffffff"
                        style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                        <p style="margin: 0;">Do not share this OTP with anyone. Nhóm 2 takes your account
                            security very seriously. Java Group04 Customer Service will never ask you to disclose or
                            verify your Nhóm 2 password, OTP, credit card, or banking account number. If you
                            receive a suspicious email with a link to update your account information, do not click on
                            the link—instead, report the email to Nhóm 2 for investigation. Thank you!</p>
                    </td>
                </tr>
                <!-- end copy -->
                ...
                <tr>
                    <td align="left" bgcolor="#ffffff"
                        ...
                        <p style="margin: 0;">Cheers,<br> Nhóm 2 Team</p>
                    </td>
                </tr>
                <!-- end copy -->
